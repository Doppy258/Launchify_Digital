...
const services = [
  {
    ...
    description:
      "We craft eye-catching, modern designs tailored to your brand. Our focus is on creating an intuitive user experience that engages your audience and drives conversions. From initial concept to final polish, we ensure your website is both beautiful and functional.",
    features: [
  ...
  },
  {
    ...
    description:
      "Our expert web developers bring your designs to life with clean, efficient, and scalable code. We build robust websites using the latest technologies, ensuring fast-loading pages, SEO-friendly structure, and secure functionality for a seamless user journey.",
    features: [
      ...
      >
        <div className="container px-4 md:px-6 mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto">
            At Launchify Digital, we provide a full suite of web services designed to elevate your online presence. From custom web design to ongoing maintenance, we are your trusted partner in the digital world.
          </p>
        </div>
      </motion.section>
